...
public class BTDisplay extends JFrame {
    // Frame dimensions
    private int WIDTH = 500; 
    private int HEIGHT = 300;
    private BinarySearchTree tree; // tree to be drawn
    ...
    private final int SY = 30;
    private final int DX = 30;
	...
	nodeColor = new Color(255,200,200); // pink
    ...
    */
	...
	g.drawString(((KeyedObject)(r.element)).key().toString()+":" + r.height,x+sx/5,y+2*sy/3);
